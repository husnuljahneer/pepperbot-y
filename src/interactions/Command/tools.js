...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("word")
            .setDescription("The word you want to form")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand.setName("calculator").setDescription("Calculate a sum")
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("decode")
        ...
        .addStringOption((option) =>
          option
            .setName("code")
            .setDescription("The binary code you want to decode")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("ip")
            .setDescription("The ip of the mc server")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand.setName("pwdgen").setDescription("Generate a password")
    )
    .addSubcommand((subcommand) =>
      subcommand
        .setName("qrcode")
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("time")
            .setDescription("The time for your reminder")
            .setRequired(true)
        )
        .addStringOption((option) =>
          option
            .setName("message")
            .setDescription("The message for your reminder")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("language")
            .setDescription("The language of your code")
            .setRequired(true)
        )
        .addStringOption((option) =>
    ...
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option
            .setName("site")
            .setDescription("The link to the website")
            .setRequired(true)
        )
        .addStringOption((option) =>
          option
            .setName("code")
            .setDescription("The code for the url")
            .setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addStringOption((option) =>
          option.setName("chat").setDescription("Your Prompt").setRequired(true)
        )
    )
    .addSubcommand((subcommand) =>
      subcommand
        ...
        .addNumberOption((option) =>
          option
            .setName("stars")
            .setDescription("The number of stars (max 5)")
            .setRequired(true)
        )
        .addStringOption((option) =>
          option
            .setName("message")
            .setDescription("A small description with the review")
        )
    ),
  /**
   * @param {Client} client
